...
class TBSystemUser
{
    ...
    /**
     * @var \Arte\PCMS\PublicBundle\Entity\TBDepartment
     */
     ...
     *
     * @param \Arte\PCMS\PublicBundle\Entity\TBProjectUser $tBProjectUsersSystemUserId
     * @return TBSystemUser
     */
    public function addTBProjectUsersSystemUserId(\Arte\PCMS\PublicBundle\Entity\TBProjectUser $tBProjectUsersSystemUserId)
    {
     ...
     * @param \Arte\PCMS\PublicBundle\Entity\TBProjectUser $tBProjectUsersSystemUserId
     */
    public function removeTBProjectUsersSystemUserId(\Arte\PCMS\PublicBundle\Entity\TBProjectUser $tBProjectUsersSystemUserId)
    {
     ...
     *
     * @param \Arte\PCMS\PublicBundle\Entity\TBProjectMaster $tBProjectMastersManagerId
     * @return TBSystemUser
     */
    public function addTBProjectMastersManagerId(\Arte\PCMS\PublicBundle\Entity\TBProjectMaster $tBProjectMastersManagerId)
    {
     ...
     * @param \Arte\PCMS\PublicBundle\Entity\TBProjectMaster $tBProjectMastersManagerId
     */
    public function removeTBProjectMastersManagerId(\Arte\PCMS\PublicBundle\Entity\TBProjectMaster $tBProjectMastersManagerId)
    {
     ...
     *
     * @param \Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersSystemUserId
     * @return TBSystemUser
     */
    public function addVProjectUsersSystemUserId(\Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersSystemUserId)
    {
     ...
     * @param \Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersSystemUserId
     */
    public function removeVProjectUsersSystemUserId(\Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersSystemUserId)
    {
     ...
     *
     * @param \Arte\PCMS\PublicBundle\Entity\VProjectView $vProjectViewsManagerId
     * @return TBSystemUser
     */
    public function addVProjectViewsManagerId(\Arte\PCMS\PublicBundle\Entity\VProjectView $vProjectViewsManagerId)
    {
     ...
     * @param \Arte\PCMS\PublicBundle\Entity\VProjectView $vProjectViewsManagerId
     */
    public function removeVProjectViewsManagerId(\Arte\PCMS\PublicBundle\Entity\VProjectView $vProjectViewsManagerId)
    {
     ...
     *
     * @param \Arte\PCMS\PublicBundle\Entity\TBProductionCost $tBProductionCostsSystemUserId
     * @return TBSystemUser
     */
    public function addTBProductionCostsSystemUserId(\Arte\PCMS\PublicBundle\Entity\TBProductionCost $tBProductionCostsSystemUserId)
    {
     ...
     * @param \Arte\PCMS\PublicBundle\Entity\TBProductionCost $tBProductionCostsSystemUserId
     */
    public function removeTBProductionCostsSystemUserId(\Arte\PCMS\PublicBundle\Entity\TBProductionCost $tBProductionCostsSystemUserId)
    {
     ...
     *
     * @param \Arte\PCMS\PublicBundle\Entity\TBDepartment $tBDepartmentDepartmentId
     * @return TBSystemUser
     */
    public function setTBDepartmentDepartmentId(\Arte\PCMS\PublicBundle\Entity\TBDepartment $tBDepartmentDepartmentId = null)
    {
     ...
     *
     * @return \Arte\PCMS\PublicBundle\Entity\TBDepartment 
     */
