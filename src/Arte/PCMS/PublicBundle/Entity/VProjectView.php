...
class VProjectView
{
     ...
     *
     * @param \Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersProjectMasterId
     * @return VProjectView
     */
    public function addVProjectUsersProjectMasterId(\Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersProjectMasterId)
    {
     ...
     * @param \Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersProjectMasterId
     */
    public function removeVProjectUsersProjectMasterId(\Arte\PCMS\PublicBundle\Entity\VProjectUser $vProjectUsersProjectMasterId)
    {
